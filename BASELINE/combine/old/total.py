...
def Load(proc_list):
	...
	process_list = [First, Second, Third, Fourth, Fifth]
	return process_list
...
WWZ = '/home/bjpark/WWZ/DRAW/baseline/npy/combine/proc/*.npy'
...
np.save('/home/bjpark/WWZ/DRAW/baseline/npy/combine/proc/combined/{0}'.format(outname), combine)

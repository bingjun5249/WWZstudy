...
def LepZ1_PT(stk_lepPT, WWZ_lepPT, weight, color, label, order):
...
def LepZ2_PT(stk_lepPT, WWZ_lepPT, weight, color, label, order):
...
def LepW1_PT(stk_lepPT, WWZ_lepPT, weight, color, label, order):
...
def LepW2_PT(stk_lepPT, WWZ_lepPT, weight, color, label, order):
...
for ch in ch_list:
	os.chdir('/home/bjpark/WWZ/DRAW/baseline/png/presel/'+ch+'/')

	# Data load
	infile = '/home/bjpark/WWZ/DRAW/baseline/npy/presel_archive/'+ch+'/'+ch+'_channel.npy'
...
#	sig = math.sqrt(2 * (sig_yield + back_yield) * math.log(1 + (sig_yield / back_yield)) - sig_yield)
	...
	LepZ1_PT(stk_fstlepPT, WWZ['fstlep_pt'], weight, color, label, '1st')

	# fst Lepton Eta
	Lep_Eta(stk_fstlepEta, WWZ['fstlep_eta'], weight, color, label, '1st')

	# snd Lepton PT
	LepZ2_PT(stk_sndlepPT, WWZ['trdlep_pt'], weight, color, label, '2nd')

	# snd Lepton Eta
	Lep_Eta(stk_sndlepEta, WWZ['sndlep_eta'], weight, color, label, '2nd')

	# trd Lepton PT
	LepW1_PT(stk_trdlepPT, WWZ['trdlep_pt'], weight, color, label, '3rd')

	# trd Lepton Eta
	Lep_Eta(stk_trdlepEta, WWZ['trdlep_eta'], weight, color, label, '3rd')

	# frt Lepton PT
	LepW2_PT(stk_frtlepPT, WWZ['frtlep_pt'], weight, color, label, '4th')
